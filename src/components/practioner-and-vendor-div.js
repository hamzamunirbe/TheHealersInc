...
const PractionerAndVendorDiv = () => {
  return (
    <section className="self-stretch flex flex-row items-start justify-center max-w-full text-left text-5xl text-neutral-1 font-web-primary-h2-primary-dm-sans">
