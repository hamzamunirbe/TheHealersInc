...
const FrameComponent3 = () => {
  return (
    <form className="m-0 self-stretch flex flex-col items-start justify-start gap-[40px] max-w-full mq450:gap-[20px]">
      <div className="relative text-base leading-[24px] font-web-primary-h2-primary-dm-sans text-m3-black text-left inline-block max-w-full">
      ...
      <div className="self-stretch flex flex-col items-start justify-start gap-[32px] max-w-full mq450:gap-[16px]">
        <div className="self-stretch flex flex-row items-start justify-start max-w-full">
          <div className="h-[53px] flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-[5.5px] box-border gap-[5.5px] max-w-full">
            <div className="relative text-xs leading-[18px] font-web-primary-h2-primary-dm-sans text-text-secondary text-left inline-block min-w-[60px]">
              First Name
            </div>
            <input
        ...
        <div className="self-stretch flex flex-row items-start justify-start max-w-full">
          <div className="h-[53px] flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-[5.5px] box-border gap-[5.5px] max-w-full">
            <div className="relative text-xs leading-[18px] font-web-primary-h2-primary-dm-sans text-text-secondary text-left inline-block min-w-[59px]">
              Last Name
            </div>
            <input
              className="w-full [border:none] [outline:none] bg-[transparent] self-stretch h-6 flex flex-row items-start justify-start font-web-primary-h2-primary-dm-sans text-base text-m3-ref-neutral-neutral20 min-w-[250px]"
        ...
        <div className="self-stretch flex flex-row items-start justify-start max-w-full">
          <div className="h-[53px] flex-1 flex flex-col items-start justify-start pt-0 px-0 pb-[5.5px] box-border gap-[5.5px] max-w-full mq450:h-auto">
            ...
            <div className="self-stretch flex flex-row items-start justify-start max-w-full [row-gap:20px] mq450:flex-wrap">
              ...
              <input
                className="w-[calc(100%_-_24px)] [border:none] [outline:none] font-web-primary-h2-primary-dm-sans text-base bg-[transparent] h-6 flex-1 relative leading-[24px] text-m3-ref-neutral-neutral20 text-left inline-block min-w-[265px] max-w-full p-0"
                placeholder="************"
                type="text"
              />
      ...
      <div className="self-stretch flex flex-row items-start justify-center gap-[11px] mq450:flex-wrap">
        ...
        <div className="relative text-xs leading-[18px] font-web-primary-h2-primary-dm-sans text-neutral-10 text-left inline-block min-w-[14px] mq450:w-full mq450:h-3.5">
          Or
        </div>
        <div className="flex-1 flex flex-col items-start justify-start pt-[9px] px-0 pb-0 box-border min-w-[129px]">
          <div className="self-stretch h-0.5 relative box-border border-t-[2px] border-solid border-neutral-3" />
      ...
      <div className="flex flex-col items-start justify-start gap-[24px]">
        <div className="flex flex-row items-start justify-start gap-[8px]">
          <div className="relative text-sm leading-[22px] font-web-primary-h2-primary-dm-sans text-gray-300 text-left whitespace-nowrap">
            Don’t have an account?
          </div>
          <div className="relative text-sm [text-decoration:underline] leading-[22px] font-semibold font-web-primary-h2-primary-dm-sans text-material-theme-source-primary text-left inline-block min-w-[45px] whitespace-nowrap">
            Sign In
          </div>
        </div>
        <button className="cursor-pointer py-[9px] px-4 bg-neutral-1 rounded shadow-[0px_2px_0px_rgba(0,_0,_0,_0.02)] flex flex-row items-start justify-start gap-[10px] border-[1px] border-solid border-neutral-5">
          ...
          <b className="w-[94px] relative text-sm leading-[24px] inline-block font-web-primary-h2-primary-dm-sans text-neutral-9 text-center min-w-[94px] whitespace-nowrap">
            Back to home
          </b>
        </button>
      </div>
