const WhyChooseUs1 = () => {
  return (
    <section className="self-stretch flex flex-col items-center justify-center py-14 px-0 box-border gap-[56px] max-w-full text-center text-smi text-consumer-colors-monochromatic font-web-primary-h2-primary-dm-sans mq750:gap-[28px] mq750:pt-9 mq750:pb-9 mq750:box-border">
      ...
      <div className="w-[1240px] flex flex-row flex-wrap items-start justify-center py-0 px-[164px] box-border gap-[56px] min-h-[236px] max-w-full text-left text-2xl text-gray-300 mq750:gap-[28px] mq750:pl-[41px] mq750:pr-[41px] mq750:box-border mq1225:pl-[82px] mq1225:pr-[82px] mq1225:box-border">
