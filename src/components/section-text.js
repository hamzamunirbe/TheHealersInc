const SectionText = () => {
  return (
    <div className="self-stretch flex flex-col items-start justify-start gap-[32px] max-w-full text-left text-xl text-blue-gray-900 font-components-helper-text mq750:gap-[16px]">
      <div className="self-stretch flex flex-col items-start justify-start gap-[16px]">
        ...
        <h1 className="m-0 self-stretch relative text-37xl leading-[110%] font-bold font-web-primary-h2-primary-dm-sans mq450:text-15xl mq450:leading-[37px] mq750:text-26xl mq750:leading-[49px]">
          Optimize Your Healing Practices
        </h1>
      </div>
      <div className="self-stretch relative leading-[180%] font-web-primary-h2-primary-dm-sans mq450:text-base mq450:leading-[29px]">
