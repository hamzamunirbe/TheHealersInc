const ButtonBusinessCard2 = ({ monogram, header, subhead }) => {
  return (
    <div className="rounded-xl bg-neutral-1 shadow-[0px_1px_2px_rgba(0,_0,_0,_0.3),_0px_1px_3px_1px_rgba(0,_0,_0,_0.15)] flex flex-row items-start justify-start text-left text-xl text-neutral-10 font-web-primary-h2-primary-dm-sans">
